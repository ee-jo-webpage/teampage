...
<%--                                <small class="text-muted">04:10 • Sports</small>--%>
                        ...
                        <div class="playlist-item d-flex align-items-center p-2 mb-2" style="background-color: #f8f9fa; border-radius: 5px; cursor: pointer;" onclick="playVideo('../video/videos/steak.mp4', 'Barbecue Mastery')">
                            <div class="mr-3" style="min-width: 50px;">
                                <i class="fa fa-play-circle" style="font-size: 24px; color: #dc8cdb;"></i>
                            </div>
                            <div>
